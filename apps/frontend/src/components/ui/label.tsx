...
const labelVariants = cva('font-heading text-[11px] font-bold uppercase leading-none tracking-[0.18em] text-slate-300 peer-disabled:cursor-not-allowed peer-disabled:opacity-70');
